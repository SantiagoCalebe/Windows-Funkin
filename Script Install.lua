...
function onCreatePost()
  ...
  if tonumber(versionW) < tonumber(versionNumber) then
    ...
    verseTranslate('s', 'portuguese', 'SUCESSO')
    verseTranslate('log', 'portuguese', 'Atualizações [TAB]')
    ...
    verseTranslate('s', 'spanish', 'ÉXITO')
    verseTranslate('log', 'spanish', 'actualizaciones [TAB]')
